                                    ...
                                    <li class="d-flex py-2 align-items-start">
                                        ...
                                        <div class="d-flex align-items-start justify-content-between flex-grow-1">
                                            <div>
                                                ...
                                                <p class="text-muted lh-1 mb-2 small">Hi Jack, can we setup a meeting...
                                                </p>
                                            </div>
                                    ...
                                    <li class="d-flex py-2 align-items-start">
                                        ...
                                        <div class="d-flex align-items-start justify-content-between flex-grow-1">
                                            <div>
                                                ...
                                                <p class="text-muted lh-1 mb-2 small">Monthly staff review starts in...
                                                </p>
                                            </div>
                                            <small
                                    ...
                                    <li class="d-flex py-2 align-items-start">
                                        ...
                                        <div class="d-flex align-items-start justify-content-between flex-grow-1">
                                            <div>
                                                ...
                                                <p class="text-muted lh-1 mb-2 small">Placed by Sally Smith at 10:07 AM
                                                </p>
                                            </div>
                                            <small
