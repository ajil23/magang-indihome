        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-md-6">
                <div class="card h-100 bg-primary border-primary">
                    <div
                        class="card-header bg-transparent justify-content-between align-items-center d-flex border-0 pb-0">
                        <div class="d-flex align-items-center flex-shrink-0">
                            <i class="ri-calendar-line me-2 text-white opacity-75 ri-lg"></i>
                            <h6 class="card-title m-0 text-light fs-xs text-uppercase fw-bolder tracking-wide">Upcoming
                                Events</h6>
                        </div>
                    ...
                    <div class="card-body mt-3">
                        <div class="d-flex flex-grow-1 overflow-hidden text-white">
                            <!-- Swiper Latest -->
                            <div class="swiper-container overflow-hidden w-auto" data-swiper
                                data-options='{
                        "spaceBetween": 10,
                        "loop": true,
                        "slidesPerView": 1,
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide text-white">
                                        ...
                                        <div class="d-flex mb-4 align-items-start">
                                            <div class="me-3 text-center pe-3 border-end-white-opacity">
                                                <span
                                                    class="d-block text-uppercase small fw-bolder tracking-wide lh-1">Wed</span>
                                                <span
                                                    class="d-block fs-3 text-uppercase fw-bold tracking-wide lh-1 mt-1">12</span>
                                            </div>
                                            <div>
                                                <p class="mb-0 fs-5 fw-bolder lh-1">Quarterly Staff Review</p>
                                                <small class="d-block lh-1 opacity-75 mt-2">Review sales staff with Mike,
                                                    John, Sally</small>
                                            </div>
                                        </div>
                                        <!-- / Event Date & Title-->
                                        ...
                                        <div class="d-flex align-items-start mb-5">
                                            <button class="btn-icon bg-white opacity-25 me-3"><i
                                        ...
                                        <!-- Attendees & CTA-->
                                        <div
                                            class="d-flex justify-content-start align-items-start flex-column flex-lg-row justify-content-lg-between">
                                            <div class="avatar-group me-4">
                                                <picture class="avatar-group-img">
                                                    <img class="f-w-10 rounded-circle border-primary"
                                                        src="./assets/images/profile-small.jpeg" alt="">
                                                </picture>
                                                <picture class="avatar-group-img">
                                                    <img class="f-w-10 rounded-circle border-primary"
                                                        src="./assets/images/profile-small-2.jpeg" alt="">
                                                </picture>
                                                <picture class="avatar-group-img">
                                                    <img class="f-w-10 rounded-circle border-primary"
                                                        src="./assets/images/profile-small-3.jpeg" alt="">
                                                </picture>
                                                <picture class="avatar-group-img">
                                                    <img class="f-w-10 rounded-circle border-primary"
                                                        src="./assets/images/profile-small-4.jpeg" alt="">
                                                </picture>
                                            ...
                                            <div class="mt-3 mt-lg-0">
                                                ...
                                                <button
                                                    class="btn btn-sm btn-link text-white fw-bolder opacity-75">Cancel</button>
                                            </div>
                                        </div>
                                        <!-- Attendees & CTA-->
                                    </div>
                                    <div class="swiper-slide text-white">
                                        ...
                                        <div class="d-flex mb-4 align-items-start">
                                            <div class="me-3 text-center pe-3 border-end-white-opacity">
                                                <span
                                                    class="d-block text-uppercase small fw-bolder tracking-wide lh-1">Thu</span>
                                                <span
                                                    class="d-block fs-3 text-uppercase fw-bold tracking-wide lh-1 mt-1">22</span>
                                            </div>
                                            <div>
                                                <p class="mb-0 fs-5 fw-bolder lh-1">Yearly Budget Review</p>
                                                <small class="d-block lh-1 opacity-75 mt-2">Budget meeting with Patrick and
                                                    Debbie</small>
                                            </div>
                                        </div>
                                        <!-- / Event Date & Title-->
                                    ...
                                    <div class="swiper-slide text-white">
                                        ...
                                        <div class="d-flex mb-4 align-items-start">
                                            <div class="me-3 text-center pe-3 border-end-white-opacity">
                                                <span
                                                    class="d-block text-uppercase small fw-bolder tracking-wide lh-1">Mon</span>
                                                <span
                                                    class="d-block fs-3 text-uppercase fw-bold tracking-wide lh-1 mt-1">28</span>
                                            </div>
                                            <div>
                                                <p class="mb-0 fs-5 fw-bolder lh-1">Summer Staff Party</p>
                                                <small class="d-block lh-1 opacity-75 mt-2">Yearly company summer
                                                    party</small>
                                            </div>
                                        </div>
                                        <!-- / Event Date & Title-->
                    ...
                    <div class="card-body overflow-hidden">
                        <div class="row gx-2 h-100">
                            <div class="col-3 d-none d-xl-flex h-100 align-items-center">
                                <picture>
                                    <img class="w-100" src="./assets/images/refer.svg"
                                        alt="HTML Bootstrap Admin Template by Pixel Rocket">
                                </picture>
                            </div>
                            <div
                                class="col-12 col-xl-6 d-flex flex-column justify-content-center align-items-center text-center h-100">
                                <p class="fw-bold fs-5">Refer a friend and get one month's pro subscription free</p>
                                <p class="text-muted">We'll give you a month's pro subscription for every friend that signs
                                    up to Apollo.</p>
                                <a href="#" class="btn btn-outline-secondary btn-sm text-body"><i
                                        class="ri-file-copy-line align-middle"></i> Copy invite code</a>
                            </div>
                            <div class="col-3 d-none d-xl-flex h-100 align-items-center">
                                <picture>
                                    <img class="w-100" src="./assets/images/refer-2.svg"
                                        alt="HTML Bootstrap Admin Template by Pixel Rocket">
                                </picture>
                            </div>
                        </div>
                        ...
                        <ul class="list-unstyled m-0">
                            <li class="d-flex justify-content-between py-2">
                                <div class="d-flex align-items-center">
                                    <span class="f-w-4 me-3 lh-1">
                                        <picture>
                                            <img class="img-fluid" src="./assets/images/logos/logo-17.svg"
                                                alt="">
                                        </picture>
                                    </span>
                            ...
                            <li class="d-flex justify-content-between py-2">
                                <div class="d-flex align-items-center">
                                    <span class="f-w-4 me-3 lh-1">
                                        <picture>
                                            <img class="img-fluid" src="./assets/images/logos/logo-18.svg"
                                                alt="">
                                        </picture>
                                    </span>
                            ...
                            <li class="d-flex justify-content-between py-2">
                                <div class="d-flex align-items-center">
                                    <span class="f-w-4 me-3 lh-1">
                                        <picture>
                                            <img class="img-fluid" src="./assets/images/logos/logo-19.svg"
                                                alt="">
                                        </picture>
                                    </span>
                    ...
                    <div class="overflow-hidden">
                        ...
                        <div class="d-flex align-items-end justify-content-start mb-4 flex-wrap">
                            ...
                            <div class="d-flex justify-content-start flex-column align-items-start col">
                                <small class="text-muted fs-xs fw-bolder"><span class="fw-bold">Patrick Johnson</span>
                                    &middot; 2 mins ago</small>
                        ...
                        <div class="d-flex align-items-end justify-content-start mb-4 flex-wrap">
                            <div class="d-flex justify-content-end flex-column align-items-end col">
                                <small class="text-muted fs-xs fw-bolder"><span class="fw-bold">You</span> &middot; 5
                                    mins ago</small>
